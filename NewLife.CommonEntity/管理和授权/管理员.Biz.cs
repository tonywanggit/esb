...
namespace NewLife.CommonEntity
{
        ...
        where TLogEntity : Log<TLogEntity>, new()
    {
        ...
        public override int Save()
        {
            ...
            this.Password = DataHelper.Hash(this.Name + this.Password);
        ...
        where TEntity : Administrator<TEntity>, new()
    {
        ...
        protected override void InitData()
        {
            ...
            user.Name = "admin";
            user.Password = DataHelper.Hash("adminadmin");
        ...
        public static IAdministrator CurrentAdministrator
        {
            get
            {
                //return PropertyInfoX.Create(typeof(IAdministrator), "Current").GetValue() as IAdministrator;
                return Current as IAdministrator;
            }
        }
        ...
        static TEntity Login(String username, String password, Int32 hashTimes)
        {
            ...
            if (user == null) throw new Exception("帐户[" + username + "]不存在！");
        ...
        {
            IEntityOperate op = EntityFactory.CreateOperate(typeof(Administrator));
