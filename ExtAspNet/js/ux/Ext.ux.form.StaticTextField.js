 ...
 * @modified by sanshi.ustc@gmail.com 2008-4-18
 *      + extends Ext.BoxComponent  -> extends Ext.form.Field, because we what to use  Ext.form.Field.prototype.labelSeparator = '';
 *      + 
 */
...
Ext.extend(Ext.ux.form.StaticTextField, Ext.form.Field,  {
    /**
    ...
    /**
     * added by sanshi.ustc@gmail.com 2008-4-18
     * @cfg {Boolean} encodeValue True to encode the value
     */
    encodeValue : true,
    ...
    setValue : function(v){
        this.value = v;
        if(this.rendered){
            // added by sanshi.ustc@gmail.com at 2008-4-18
            if(this.encodeValue){
